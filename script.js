document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.closest && (input.matches('[name="name"], #name, [name="email"], #email, [name="phone"], #phone, [name="message"], #message'))) {
                clearError(input);
            }
        });
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4b46da2e-e794-436d-8c4b-d0b87e704c1c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4b46da2e-e794-436d-8c4b-d0b87e704c1c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4b46da2e-e794-436d-8c4b-d0b87e704c1c';
